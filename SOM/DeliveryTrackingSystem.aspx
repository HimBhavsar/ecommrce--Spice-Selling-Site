<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryTrackingSystem.aspx.cs" Inherits="SOM.DeliveryTrackingSystem" %>
...
<body class="main-registration">
    <form runat="server">
        ...
        <div class="container" style="padding: 0px;">
            <asp:LinkButton ID="lblHome" runat="server" Style="margin-left: 15px;" CssClass="navigation-link" Text="Home" OnClick="LblHome_Click"></asp:LinkButton><br />
            <asp:Image ID="imgEmptyCart" runat="server" ImageUrl="~/images/DeliveryTrackingSystem.png" CssClass="DataLostImg" />
            <br />
            <asp:Label Text="Delivery Tracking System will available soon!" CssClass="DeliverySystemLabel" ID="lblNoData" runat="server" />
        </div>
        <!-- Modal -->
