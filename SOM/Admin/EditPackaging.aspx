<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPackaging.aspx.cs" Inherits="SOM.Admin.EditPackaging" %>
...
<body class="main-registration">
    <form runat="server">
        ...
        <div class="container ContainerMargin">
            ...
            <asp:Label Text="&nbsp/&nbsp" CssClass="navigation-link" runat="server" /><asp:LinkButton ID="lnkViewPackagings" Text="Product Packages" runat="server" CssClass="navigation-link" OnClick="lnkViewPackagings_Click" CausesValidation="false" />
            <div class="registration-middle">
                <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33 login100-form validate-form flex-sb flex-w">
                    ...
                    <asp:Button Text="UPDATE" CssClass="login100-form-btn container-login100-form-btn m-t-17 registration-button" runat="server" ID="btnSubmit" OnClick="btnSubmit_Click" />
                </div>
            </div>
        </div>
    </form>
