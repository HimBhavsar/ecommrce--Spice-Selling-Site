<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProduct.aspx.cs" Inherits="SOM.Admin.EditProduct" %>
...
<body class="main-registration">
    <form runat="server">
        ...
        <div class="container ContainerMargin">
            ...
            <asp:LinkButton ID="lblHome" CausesValidation="false" runat="server" Visible="true" CssClass="navigation-link" Text="Home" OnClick="lblHome_Click"></asp:LinkButton><asp:Label Text="&nbsp/&nbsp" CssClass="navigation-link" runat="server" /><asp:LinkButton ID="lnkViewProduct" CausesValidation="false" CssClass="navigation-link" Text="Product List" OnClick="lnkViewProduct_Click" runat="server" />
            <div class="registration-middle">
                <div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33 login100-form validate-form flex-sb flex-w">
                    ...
                    <div class="form-left">
                        <div class="wrap-input100 validate-input" data-validate="Username is required">
                            <asp:Image ID="Image1" runat="server" style="width:50%; margin-bottom: 15px; " /><br />
                            <asp:Label Text="" ID="lblImageName" runat="server" CssClass="imgName" />
