<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="SOM.Home" %>
        ...
        <div class="product-main">
            <div class="container">
                <div class="">
                    <div class="home-left">
                        <div class="home">
                            <a href="Products.aspx" style="text-decoration: none; color: #000">
                                <div class="home-text">Place New Order</div>
                                <div class="home-circal">
                                    <img class="zoom" src="images/Home-add-product-icon.png">
                                </div>
                            </a>
                        </div>
                    </div>
                    <div class="home-right">
                        <div class="home">
                            <a href="MyOrders.aspx" style="text-decoration: none; color: #000">
                                <div class="home-text">My Orders</div>
                                <div class="home-circal">
                    ...
                    <div class="home-bottom">
                        <div class="home">
                            <a href="DeliveryTrackingSystem.aspx" style="text-decoration: none; color: #000">
                                <div class="home-text">Delivery Status</div>
                                <div class="home-circal">
                                    <img class="zoom" src="images/delivery.png">
                                </div>
                            </a>
                        </div>
                    </div>
