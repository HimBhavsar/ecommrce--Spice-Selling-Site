<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataLost.aspx.cs" Inherits="SOM.DataLost" %>
...
<body class="main-registration">
    <form runat="server">
        ...
        <div>
            <asp:Image ID="imgEmptyCart" runat="server" ImageUrl="~/images/SadCloud.png" CssClass="DataLostImg" />
            <br />
            <asp:Label Text="Oops !!! Seems We have lost your data due to inactivity in the site<br/>Please Relogin and order again" CssClass="DataLostLabel" ID="lblNoData" runat="server" />
            <br/>
            <asp:Button Text="Re-Login" runat="server" ID="btnReLogin" CssClass="place-main login100-form-btn" style="position: fixed !important;" OnClick="BtnReLogin_Click"/>
        </div>
